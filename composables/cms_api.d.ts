...
type CMS_API_HomePage = {
    ...
    notreEntreprise_titre_couleur?: string,
    notreEntreprise_titre_taille?: string,
    notreEntreprise_colonne_gauche: CMS_API_Block[],
    notreEntreprise_colonne_droite: CMS_API_Block[],
    nosServices_titre: string,
    nosServices_titre_couleur?: string,
    nosServices_titre_taille?: string,
...
type CMS_API_ServicesPage = {
    ...
    nosServices_colonne_droite: CMS_API_Block[],
    notreDemarche_titre: string,
    notreDemarche_titre_couleur?: string,
    notreDemarche_titre_taille?: string,
    notreDemarche: CMS_API_Block[],
    controleBornes_titre: string,
    controleBornes_titre_couleur?: string,
    controleBornes_titre_taille?: string,
    ...
    controlePhotovoltaique_titre_couleur?: string,
    controlePhotovoltaique_titre_taille?: string,
...
type CMS_API_ContactPage = {
    ...
    formulaire_titre_couleur?: string,
    formulaire_titre_taille?: string,
